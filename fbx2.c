...
#define SCREEN_GC9A01    3 // Circular 240 x 240 display
...
initGC9A01[] = {
	...
	0x8F, 1, 0xFF, // ?
	0xB6, 2, 0x00, 0x00, // ?
	//0x36, 1, 0x40 | 0x08, //changed 08 to 00
	0x36, 0x08,
	0x3A, 1, 0x05,
...
static const struct {
  ...
  { 240, 240, 80000000, initGC9A01 , winGC9A01} };
...
int main(int argc, char *argv[]) {
	...
	while((i = getopt(argc, argv, "otigb:w:s")) != -1) {
		switch(i) {
		   ...
		   case 'i': // Select IPS screen type
			...
			break;
		   case 'g': // Select GC9A01 screen
		    screenType = SCREEN_GC9A01;
			break;
		   case 'b': // SPI bitrate
